...
{"intent":"ops","confidence":0.9,"ops":[
 ...
 {"op":"create","shape":"circle","name":"雪人身体","fill":"${C['白']}","stroke":"${C['灰']}","at":{"x":512,"y":540},"size":150,"desc":"画雪人的身体"},
 {"op":"create","shape":"circle","name":"雪人头","fill":"${C['白']}","stroke":"${C['灰']}","at":{"ref":{"byName":"雪人身体"},"anchor":"top","gap":-30},"size":95,"desc":"画雪人的头"},

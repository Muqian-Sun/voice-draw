...
# 尺寸 size
数字=特征尺寸（圆为半径）；"small"=${SEMANTIC_SIZE.small} "medium"=${SEMANTIC_SIZE.medium} "large"=${SEMANTIC_SIZE.large}；
...
{"intent":"ops","confidence":0.9,"ops":[
 ...
 {"op":"create","shape":"triangle","name":"鼻子","fill":"${C['橙']}","at":{"ref":{"byName":"雪人头"},"anchor":"center","offset":[0,14]},"size":12,"rotation":90,"desc":"画胡萝卜鼻子"}
],"say":"雪人画好啦"}
`
}
